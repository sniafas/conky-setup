...
{
    name='fs_used_perc',           arg='/media/steve/FreeAgent Drive',                     max_value=100,
    x=75,                          y=690,
    graph_radius=70,
    graph_thickness=5,
    graph_start_angle=180,
    ...
    graduation_unit_angle=27,
    graduation_fg_colour=0xFFFFFF, graduation_fg_alpha=0.3,
    caption='FreeAgent Drive',
    caption_weight=1,              caption_size=17.0,
    caption_fg_colour=0xFFFFFF,    caption_fg_alpha=0.5,
},

{
    name='fs_used_perc',           arg='/media/steve/Backup',                     max_value=100,
    x=75,                          y=690,
    graph_radius=60,
    graph_thickness=5,
    graph_start_angle=180,
...
{
    name='fs_used_perc',           arg='/media/steve/Data',                     max_value=100,
    x=75,                          y=690,
    graph_radius=50,
    graph_thickness=5,
    graph_start_angle=180,
...
{
    name='fs_used_perc',           arg='/media/steve/Data4T',                     max_value=100,
    x=75,                          y=690,
    graph_radius=40,
    graph_thickness=5,
    graph_start_angle=180,
